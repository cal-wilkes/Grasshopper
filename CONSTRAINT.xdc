...
set_property PACKAGE_PIN W5 [get_ports clk]							
 ...
 set_property CLOCK_DEDICATED_ROUTE false[get_nets COMPARE_IBUF]
 
## Switches
set_property PACKAGE_PIN V17 [get_ports {SWITCH[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {SWITCH[2]}]
set_property PACKAGE_PIN V16 [get_ports {CHANGE}]					
...
#set_property PACKAGE_PIN T17 [get_ports {buttons[2]}]						
	#set_property IOSTANDARD LVCMOS33 [get_port {buttons[2]}]
...
##Pmod Header JB
##Sch name = JB1
set_property PACKAGE_PIN A14 [get_ports {COMPARE}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {COMPARE}]
##Sch name = JB2
...
##Sch name = JB4
set_property PACKAGE_PIN B16 [get_ports {SOLENOID_CONTROL_SIG}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {SOLENOID_CONTROL_SIG}]
##Sch name = JB7
...
# TO BE HOOKED UP ON BASED ON INSTRUCTIONS FROM LAWRENCE
